...
contract FreeRiderNFTMarketplace is ReentrancyGuard {
    ...
    function _offerOne(uint256 tokenId, uint256 price) private {
        ...
        // @audit `!_token.isApprovedForAll(msg.sender, address(this))` not usefull since we check `_token.getApproved(tokenId) != address(this)`
    ...
    function _buyOne(uint256 tokenId) private {
        ...
        // @audit _token.ownerOf(tokenId) is no longer the seller !!!
